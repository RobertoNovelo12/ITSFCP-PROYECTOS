...
class ajustesDocumentoscontrolador
{
    /**
     ...
     * @return array
     */
    public function indexEditar($rol, $id_ajuste): array
    {
        global $conn;
        ...
        try {
            ...
            $id = filter_var($id_ajuste, FILTER_VALIDATE_INT);
    ...
    /**
     * Obtiene detalles de un ajuste de documento específico.
     *
     * @param string $rol
     * @param int $id_ajuste
     * @return array
     */
    public function indexDetalles($rol, $id_ajuste): array
    {
        global $conn;
        ...
        try {
            ...
            return $ajustes->obtenerDetalles($id);
        } catch (Throwable $e) {
    ...
    /**
     * Desactiva un ajuste de documento (borrado lógico).
    ...
    public function desactivar($rol, $id_ajuste)
    {
        if (!$this->esSupervisor($rol)) {
        ...
        try {
            ...
            $ajustes->obtenerPorId((int)$id_ajuste); // OBTENER EL AJUSTE DE DOCUMENTO

            $filas = $ajustes->desactivar((int)$id_ajuste);
            if ($filas < 0) {
    ...
    private function obtenerbotones($tipo, $id1 = null)
    {
        ...
        switch ($tipo) {
            case 'Editar':
                $boton = '<a href="editar.php?id_ajuste=' . $id1 . '" type="button" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
        data-bs-custom-class="custom-tooltip" data-bs-title="Editar ajuste de documento"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
  <path d="M15.502 1.94a.5.5 0 0 1 0 .706L14.459 3.69l-2-2L13.502.646a.5.5 0 0 1 .707 0l1.293 1.293zm-1.75 2.456-2-2L4.939 9.21a.5.5 0 0 0-.121.196l-.805 2.414a.25.25 0 0 0 .316.316l2.414-.805a.5.5 0 0 0 .196-.12l6.813-6.814z"/>
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
</svg></a>';
                break;
            case 'Detalles':
                $boton = '<a href="detalles.php?id_ajuste=' . $id1 . '" type="button" class="btn btn-info" data-bs-toggle="tooltip" data-bs-placement="top"
        data-bs-custom-class="custom-tooltip" data-bs-title="Ver detalles de la ajuste de documento"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-eye-fill" style="padding:0px;margin:auto;" viewBox="0 0 16 16">
  <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0"/><path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7"/></svg></a>';
                break;
            case 'Desactivar':
                $boton = '<a href="tabla.php?&id_linea=' . $id1 . '&action=desactivar" type="button" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"
        data-bs-custom-class="custom-tooltip" data-bs-title="Desactivar ajuste de documento"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0M5.354 4.646a.5.5 0 1 0-.708.708L7.293 8l-2.647 2.646a.5.5 0 0 0 .708.708L8 8.707l2.646 2.647a.5.5 0 0 0 .708-.708L8.707 8l2.647-2.646a.5.5 0 0 0-.708-.708L8 7.293z"/>
    ...
    //Crear ajuste de documento
    //REVISAR
    /*function registrarlinea($rol)
    {
        ...
        try {
            ...
            $id_ajuste = $ajustes->registrarLinea($nombre, $descripcion);
    ...
    //REVISAR
    function editarLinea($rol, $id_ajuste, $nombre, $descripcion)
    {
        ...
        try {
            $ajustes = new ajustesdocumentos($conn);
            // BLOQUEO DE CONCURRENCIA
            $verificacion = $this->obtenerPorIdDiferente((int)$id_ajuste, $nombre); // OBTENER AJUSTE DE DOCUMENTO 

            if ($verificacion['activo'] > 0 || $verificacion['desactivado'] > 0) {
                throw new Exception("Registro duplicado");
            }

            $id_ajuste = $ajustes->editarPlantillaDocumento($nombre, $descripcion, $id_ajuste);
            $id_ajuste = $ajustes->editarConfiguracionDocumento($nombre, $descripcion, $id_ajuste);
            $id_firmantes = $ajustes->editarFirmantesDocumento($nombre, $descripcion, $id_ajuste);
    ...
    //REVISAR
    public function reactivar($rol, $id_ajuste)
    {
        ...
        try {
            ...
            $ajustes->obtenerPorId($id_ajuste, true);
            //Reactivar
            $ajustes->reactivar($id_ajuste);
     ...
     */
    //REVISAR
    public function verificarFirmante($nombre): array
    {
        global $conn;
        ...
        try {
            ...
            return $ajustes->verificarFirmante($nombre);
        } catch (Throwable $e) {
