...
class carreraControlador
{
    ...
    private function obtenerbotones($tipo, $id1 = null)
    {
        ...
        switch ($tipo) {
            case 'Editar Carrera':
                $boton = '<a href="editar.php?id_carrera=' . $id1 . '" type="button" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                ...
                break;
            case 'Detalles':
                $boton = '<a href="detalles.php?id_carrera=' . $id1 . '" type="button" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top"
