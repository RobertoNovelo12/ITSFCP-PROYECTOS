...
class nivelsniControlador
{
    ...
    private function obtenerbotones($tipo, $id1 = null)
    {
        ...
        switch ($tipo) {
            case 'Editar NivelSNI':
                $boton = '<a href="editar.php?id_nivel=' . $id1 . '" type="button" class="btn btn-warning" data-bs-toggle="tooltip" data-bs-placement="top"
  ...
  <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 0 0 0-1 0v6a.5.5 0 0 1-.5.5h-11a.5.5 0 0 1-.5-.5v-11a.5.5 0 0 1 .5-.5H9a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 0 1 2.5z"/>
                ...
                break;
            case 'Detalles':
                $boton = '<a href="detalles.php?id_nivel=' . $id1 . '" type="button" class="btn btn-primary" data-bs-toggle="tooltip" data-bs-placement="top"
  ...
  <path d="M10.5 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 0 1 5 0"/><path d="M0 8s3-5.5 8-5.5S16 8 16 8s-3 5.5-8 5.5S0 8 0 8m8 3.5a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7"/></svg></a>';
                break;
            case 'Desactivar':
                $boton = '<a href="index.php?&id_nivel=' . $id1 . '&action=desactivar_niveles_sni" type="button" class="btn btn-danger" data-bs-toggle="tooltip" data-bs-placement="top"
