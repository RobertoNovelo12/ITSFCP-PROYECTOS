        ...
        switch ($tipo) {
            ...
            case 'Ver lista':
                $boton = '<a href="lista_tareas.php?id_tarea=' . $id1 . '&id_proyectos=' . $id2 . '"
                    class="btn btn-sm btn-secondary" title="Ver lista de estudiantes" data-bs-toggle="tooltip" data-bs-placement="top"
            ...
            case 'Editar Tarea':
                $boton = '<a href="editar.php?id_tarea=' . $id1 . '&id_proyectos=' . $id2 . '"
                    class="btn btn-sm btn-warning" title="Editar tarea" data-bs-toggle="tooltip" data-bs-placement="top"
            ...
            case 'Detalles':
                $boton = '<a href="detalles.php?id_tarea=' . $id1 . '&id_proyectos=' . $id2 . '"
                    class="btn btn-sm btn-primary" title="Ver detalles" data-bs-toggle="tooltip" data-bs-placement="top"
