...
include $_SERVER['DOCUMENT_ROOT'] . '/public/incluido/_validar_get.php';
...
include $_SERVER['DOCUMENT_ROOT'] . '/public/incluido/_validar_id.php';
...
$registro = $director;
include $_SERVER['DOCUMENT_ROOT'] . '/public/incluido/_validar_datos.php';
...
<div class="container-fluid py-4 ancho_container">
    ...
    <div class="row mb-4 align-items-center">
        <?php
        $titulo      = 'Detalle de Director';
        $descripcion = 'Información del director seleccionado';
