<?php
// /Mis_solicitudes/detalles_mi_solicitud.php
...
require_once __DIR__ . '/../Controller/mis_solicitudes_controller.php';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && ($_POST['accion'] ?? '') === 'responder') {
    ...
    header("Location: detalles_mi_solicitud.php?id={$id_solicitud}&msg=" . $resultado['msg']);
    exit;
}
...
$msg   = $_GET['msg'] ?? '';
$_mapa = [
    'exito_respuesta'       => ['tipo' => 'exito',  'titulo_msg' => 'Respuesta enviada',          'mensaje' => 'Tu respuesta fue enviada. El investigador la revisará.'],
    'error_comentario_vacio' => ['tipo' => 'alerta', 'titulo_msg' => 'Comentario requerido',       'mensaje' => 'El comentario no puede estar vacío.'],
    'error_no_encontrada'   => ['tipo' => 'error',  'titulo_msg' => 'Solicitud no encontrada',    'mensaje' => 'No se encontró la solicitud indicada.'],
    'error_estado_invalido' => ['tipo' => 'alerta', 'titulo_msg' => 'Acción no permitida',        'mensaje' => 'Solo puedes responder cuando la solicitud está en correcciones.'],
    'error_subida_archivo'  => ['tipo' => 'error',  'titulo_msg' => 'Error al subir archivo',     'mensaje' => 'Ocurrió un error al subir el archivo. Intenta de nuevo.'],
    'error_archivo_grande'  => ['tipo' => 'alerta', 'titulo_msg' => 'Archivo demasiado grande',   'mensaje' => 'El archivo supera el límite de 5 MB.'],
    'error_tipo_archivo'    => ['tipo' => 'alerta', 'titulo_msg' => 'Tipo de archivo no válido',  'mensaje' => 'Tipo de archivo no permitido. Usa PDF, DOCX o imágenes.'],
    'error_guardar_archivo' => ['tipo' => 'error',  'titulo_msg' => 'Error al guardar archivo',   'mensaje' => 'No se pudo guardar el archivo en el servidor.'],
    'error_guardar'         => ['tipo' => 'error',  'titulo_msg' => 'Error al guardar',           'mensaje' => 'Ocurrió un error al guardar la respuesta. Intenta de nuevo.'],
];
