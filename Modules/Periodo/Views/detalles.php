...
require_once __DIR__ . '/../../../public/incluido/_validar_get.php';

$id_periodo  = intval($_GET['id_periodos']) ?? 0;

$id_validar = $id_periodo;
require_once __DIR__ . '/../../../public/incluido/_validar_id.php';
...
require_once __DIR__ . '/../Controller/periodo_controller.php';
