...
<div class="container-fluid py-4" style="max-width:1200px;">
        ...
        <form method="GET" action="" id="form-filtro">
            <div class="row g-2 align-items-end">
                ...
                <div class="col-12 col-sm-auto d-flex gap-2">
                    ...
                    <a href="/Modules/Principal/Views/index.php" class="btn-limpiar">Limpiar</a>
                </div>
            ...
            ?>
                <div class="card-proyecto">
                    ...
                    <div class="card-footer-inner">
                        <a href="/Modules/Principal/Views/detalles_proyecto.php?id_proyectos=<?= (int)$p['id_proyectos'] ?>"
    ...
    <?php else: ?>
        ...
        <div class="vacio-wrap">
            ...
            <a href="/Modules/Principal/Views/index.php" style="font-size:13px;color:var(--tecnm-blue);">Limpiar filtros</a>
        </div>
    <?php endif; ?>
...
<script>
    (function() {
        ...
        function cargarSubtematicas(id_tematica, seleccionado = 0) {
            const url = '/Modules/Principal/Views/index.php?action=subtematicas&id_tematica=' + encodeURIComponent(id_tematica);
            fetch(url)
                .then(r => r.json())
                .then(data => {
