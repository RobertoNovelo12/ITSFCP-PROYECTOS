<?php
require_once __DIR__ . '/../Model/proyecto_model.php';
...
class ProyectoControlador extends BaseControlador
{
    ...
    public function obtenerbotones(string $tipo, int $id_proyecto, ?int $id_usuario = null): string
    {
        ...
        return match ($tipo) {
            ...
            'Detalles' => Botones::botonIcono(
                '/Modules/Proyectos/Views/detalles.php?id_proyectos=' . $id_proyecto,
                'primary',
                $iconos['tabla']['ver'],
            ...
            'Tareas' => Botones::botonIcono(
                '/Modules/Tareas/Views/index.php?id_proyectos=' . $id_proyecto,
                'info',
            ...
            'Ver Tareas Alumnos' => Botones::botonIcono(
                '/Modules/Tareas/Views/tareas_estudiante.php?id_proyectos=' . $id_proyecto,
                'info',
                $iconos['tabla']['tareas_list'],
                'Ver Tareas'
            ),
            ...
            'Solicitar cerrar' => Botones::botonIcono(
                '/Modules/Solicitudes_proyecto/Views/index.php?action=solicitarCierre&id_proyectos=' . $id_proyecto,
                'danger',
            ...
            'Ver solicitud cierre' => Botones::botonIcono(
                '/Modules/Solicitudes_proyecto/Views/index.php?id_proyectos=' . $id_proyecto,
                'warning',
                $iconos['tabla']['ver'],
            ...
            'Comentarios' => Botones::botonIcono(
                '/Modules/Proyectos/Views/ver_comentarios.php?id_proyectos=' . $id_proyecto,
                'info',
            ...
            'Volver a enviar cierre' => Botones::botonIcono(
                '/Modules/Solicitudes_proyecto/Views/index.php?action=reenviarCierre&id_proyectos=' . $id_proyecto,
                'warning',
            ...
            'Volver a enviar proyecto' => Botones::botonIcono(
                '/Modules/Proyectos/Views/editar.php?id_proyectos=' . $id_proyecto . '&desde=solicitudes',
                'warning',
                $iconos['tabla']['volver_enviar'],
            ...
            'Editar' => Botones::botonIcono(
                '/Modules/Proyectos/Views/editar.php?id_proyectos=' . $id_proyecto,
                'info',
                $iconos['tabla']['editar'],
                'Editar proyecto'
            ),
    ...
    public function registrarProyecto(array $datos, int $id, string $rol): void
    {
        ...
        try {
            ...
            $this->redirigir('exito_crear', '/Modules/Solicitudes_proyecto/Views/index.php');
        } catch (Exception $e) {
    ...
    public function editarProyecto(array $datos, int $id_usuario, string $rol): void
    {
        ...
        try {
            ...
            if ($desde === 'solicitudes') {
                $this->redirigir('exito_editar', '/Modules/Solicitudes_proyecto/Views/index.php', "&id_proyectos={$id_proyecto}");
            } else {
                $this->redirigir('exito_editar', '/Modules/Proyectos/Views/index.php', "&id_proyectos={$id_proyecto}");
            }
        } catch (Exception $e) {
            error_log($e->getMessage());
            $msg = ($e->getMessage() === 'accion_no_permitida') ? 'accion_no_permitida' : 'error_editar';
            $this->redirigir($msg, '/Modules/Proyectos/Views/index.php');
        }
    }
    ...
    public function datosproyecto(int $id_proyecto): ?array
    {
        ...
        if (!$resultado) {
            $this->redirigir('sin_permiso', '/Modules/Proyectos/Views/index.php');
        }
        return $resultado;
    }
    ...
    public function subtematicasProyecto(int $id_proyecto)
    {
        ...
        try {
            ...
            error_log($e->getMessage());
            $this->redirigir('error_cargar', '/Modules/Proyectos/Views/detalles.php', "&id_proyectos={$id_proyecto}");
        }
    }
    ...
    public function historial_estudiante_proyecto(int $id_proyecto, int $id_usuario, int $id)
    {
        ...
        try {
            ...
            error_log($e->getMessage());
            $this->redirigir('error_cargar', '/Modules/Proyectos/Views/editar.php');
        }
    }
    ...
    public function accionEstudiante(array $datos): void
    {
        ...
        if (!$id_proyecto || !$id_estudiante || !in_array($action, ['baja', 'reactivar'], true)) {
            $this->redirigir('error_operacion', '/Modules/Proyectos/Views/detalles.php', "&id_proyectos={$id_proyecto}");
        }
        ...
        try {
            ...
            $this->redirigir('exito_operacion', '/Modules/Proyectos/Views/detalles.php', "&id_proyectos={$id_proyecto}");
        } catch (Exception $e) {
            error_log($e->getMessage());
            $this->redirigir('error_operacion', '/Modules/Proyectos/Views/detalles.php', "&id_proyectos={$id_proyecto}");
        }
