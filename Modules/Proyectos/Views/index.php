...
if (!in_array($action, $accionesPermitidas, true)) {
    header('Location: /Modules/Proyectos/Views/index.php?msg=accion_no_permitida');
    exit;
}
...
<div class="container-fluid py-4 ancho_container">
        ...
        <div class="col-md-6 text-md-end d-flex justify-content-end align-items-center gap-2 flex-wrap">
            <?php if (in_array($rol, ['investigador', 'profesor'], true)): ?>
                <?php if ($puedeCrear_Editar): ?>
                    <a href="/Modules/Proyectos/Views/crear.php" class="btn btn-primary">Crear proyecto</a>
                <?php else: ?>
            ...
            <?php if (in_array($rol, ['investigador', 'profesor'], true)): ?>
                ...
                <a href="/Modules/Solicitudes_proyecto/Views/index.php" class="btn btn-outline-secondary ms-2">
    ...
    <?php if (in_array($rol, ['investigador', 'profesor'], true)): ?>
        <div class="alert alert-info d-flex align-items-center gap-2 py-2 mb-3" role="alert">
            ...
            <span>
                Los proyectos pendientes de aprobación o rechazados se gestionan en <a href="/Modules/Solicitudes_proyecto/Views/index.php" class="alert-link fw-semibold">Mis solicitudes</a>.
            </span>
        </div>
    <?php endif; ?>
    ...
    <div class="card border-0 shadow-sm mb-3">
        <div class="card-body py-2">
            <?php include __DIR__ . '/../../../public/incluido/_total_registros.php'; ?>
            <div class="row g-2 align-items-end">
                <!-- FILTRO DE ESTADO -->
                <div class="col-md-4 mb-1">
                    <label class="form-label mb-1 small fw-semibold">Estado</label>
                    <select class="form-select" onchange="location.href='/Modules/Proyectos/Views/index.php?action=' + this.value + '&buscar=<?= urlencode($buscar) ?>&id_periodo=<?= $id_periodo ?>'">
