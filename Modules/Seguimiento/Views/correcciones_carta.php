...
require_once __DIR__ . '/../Controller/seguimiento_controller.php';
...
if (!$cierre || (int)$cierre['id_usuarios'] !== $id_usuario) {
    header('Location: /Modules/Seguimiento/Views/index.php');
    exit;
}
...
<div class="container-fluid py-4 ancho_container">
    ...
    <div class="row mb-3">
        ...
        <div class="col-6 text-end">
            ...
            <a href="/Modules/Seguimiento/Views/index.php?id_proyectos=<?= $id_proyecto ?>" class="btn btn-secondary ms-2">
    ...
    <div class="hilo-wrap">
        ...
        <?php if ($puede_responder): ?>
            ...
            <div class="card border shadow-sm mb-3">
                ...
                <div class="card-body">
                    <form method="POST"
                        action="/Modules/Seguimiento/Views/index.php?action=enviarCorreccionesCarta&id_proyectos=<?= $id_proyecto ?>" enctype="multipart/form-data"
                        id="formCorrecciones"
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            <a href="/Modules/Seguimiento/Views/index.php?id_proyectos=<?= $id_proyecto ?>"
            ...
            <div class="card border shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <form method="POST"
                        action="/Modules/Seguimiento/Views/index.php?action=subirCartaTerminacion&id_proyectos=<?= $id_proyecto ?>" enctype="multipart/form-data"
                        id="formReenvio"
