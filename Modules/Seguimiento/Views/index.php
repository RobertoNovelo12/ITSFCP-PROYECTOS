...
<div class="container-fluid py-4 ancho_container">
    ...
    <?php if ($tipo && $mensaje): ?>
        <div class="row mb-2">
            <div class="col-12">
                <?php include __DIR__ . '/../../../public/incluido/_mensaje.php'; ?>
            </div>
        </div>
    <?php endif; ?>
                            ...
                            <?php elseif ($orden === 3): ?>
                                ...
                                <?php elseif ($estado === 'rechazado' || $estado === 'correcciones'): ?>
                                    ...
                                    <?php if ($etapa['plantilla'] == 1 && !empty($etapa['id_plantilla'])): ?>
                                        <a href="/Modules/Seguimiento/Views/descargar_plantilla.php?id_plantilla=<?= $etapa['id_plantilla'] ?>"
                                            class="doc-descargar">
                                    ...
                                    <?php if (!empty($etapa['cierre']['id_cierre_est'])): ?>
                                        <a href="/Modules/Seguimiento/Views/correcciones_carta.php?id=<?= $etapa['cierre']['id_cierre_est'] ?>"
                                    ...
                                    <form method="POST"
                                        action="/Modules/Seguimiento/Views/index.php?action=subirCartaTerminacion&id_proyectos=<?= $id_proyecto ?>"
