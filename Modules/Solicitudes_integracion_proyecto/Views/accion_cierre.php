...
if (!$id_seg || !$id_sol || !in_array($estado, ['completado', 'correcciones', 'rechazado'], true)) {
    header("Location: /Modules/Solicitudes_integracion_proyecto/Views/index.php");
    exit;
}

require_once __DIR__ . '/../Controller/solicitudes_controller.php';
...
<div class="container-fluid py-4 ancho_container">
    ...
    <div class="row mb-3 align-items-center">
        ...
        <div class="col-md-6 text-md-end">
            <a href="/Modules/Solicitudes_integracion_proyecto/Views/detalles_solicitud.php?id=<?= $id_sol ?>" class="btn btn-secondary btn-sm">
        ...
        <div class="card-body">
            ...
            <form method="POST" action="">
                ...
                <div class="d-flex gap-3 justify-content-end flex-wrap">
                    <a href="/Modules/Solicitudes_integracion_proyecto/Views/detalles_solicitud.php?id=<?= $id_sol ?>" class="btn btn-secondary">
