...
<div class="container-fluid py-4 ancho_container">
    ...
    <div class="row mb-3 align-items-center">
        ...
        <div class="col-md-6 text-md-end">
            <a href="/Modules/Solicitudes_integracion_proyecto/Views/detalles_solicitud.php?id=<?= $id_solicitud ?>" class="btn btn-secondary btn-sm">
        ...
        <div class="card-body">
            ...
            <form method="POST"
                ...
                <div class="d-flex gap-3 justify-content-end flex-wrap">
                    <a href="/Modules/Solicitudes_integracion_proyecto/Views/detalles_solicitud.php?id=<?= $id_solicitud ?>"
