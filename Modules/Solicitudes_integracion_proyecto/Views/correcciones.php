...
<div class="container-fluid py-4 ancho_container">
    <!-- Regresar -->
    <div class="row d-flex align-items-center mb-4 gap-3">
        <?php
        $titulo      = 'Correcciones de Carta Compromiso Solicitud #<?= $id_solicitud ?>';
        $descripcion = 'Observaciones del estudiante al investigador';
    ...
    <div class="hilo-wrap">
        ...
        <?php if ($puede_responder): ?>
            ...
            <script>
                document.getElementById('btnEnviarCorrecciones').addEventListener('click', function() {
                    ...
                    fetch('/public/Ajax/solicitudesAjax.php?action=enviarCorrecciones', {
                            method: 'POST',
                            body: fd
                        })
                        .then(r => r.json())
        ...
        <?php elseif ($detalle['estado'] === 'aceptado'): ?>
            <div class="alert alert-success text-center">
                ...
                <br>
                <a href="/Modules/Seguimiento/Views/index.php" class="btn btn-sm btn-success mt-2">
