...
require_once __DIR__ . '/../Controller/supervisor_controller.php';
...
if (empty($usuario)) {
    header("Location: /Modules/Supervisor/Views/panel_supervisor.php?tab=usuarios");
    exit;
}
...
<div cclass="container-fluid py-4 ancho_container">
    ...
    <div class="row align-items-center mb-4">
        ...
        <div class="col-auto">
            ...
            <a href="/Modules/Supervisor/Views/panel_supervisor.php?tab=usuarios" class="btn btn-secondary btn-sm ms-2">
                    ...
                    ?>
                        <div class="proy-card <?= $claseProy ?>">
                            ...
                            <div class="d-flex justify-content-between mt-2">
                                ...
                                <a href="/Modules/Supervisor/Views/detalle_proyecto.php?id=<?= $proy['id_proyectos'] ?>"
