...
if (empty($proyecto)) {
    header("Location: /Modules/Supervisor/Views/panel_supervisor.php");
    exit;
}
...
<div class="container-fluid py-4 ancho_container">
    ...
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-md-6 text-md-end">
            ...
            <a href="/Modules/Supervisor/Views/panel_supervisor.php?tab=proyectos" class="btn btn-secondary btn-sm ms-2">
