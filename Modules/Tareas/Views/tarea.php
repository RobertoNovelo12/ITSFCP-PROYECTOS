    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <?php if (in_array($rol, ['investigador', 'supervisor'], true)) : ?>
                <a href="/Modules/Tareas/Views/lista_tareas.php?id_tarea=<?= $id_tarea ?>&id_proyectos=<?= $id_proyecto ?>"
                    class="btn btn-secondary btn-sm px-3">← Regresar</a>
            <?php elseif (in_array($rol, ['estudiante', 'alumno'], true)) : ?>
                <a href="/Modules/Tareas/Views/tareas_estudiante.php?id_proyectos=<?= $id_proyecto ?>"
        ...
        <div class="card border-0 shadow-sm mb-3">
            ...
            <div class="card-body py-2 d-flex align-items-center gap-2">
                ...
                <div class="flex-grow-1">
                    ...
                    <a href="/Modules/Tareas/Views/descargar_guia.php?id=<?= $id_tarea ?>" class="small">
