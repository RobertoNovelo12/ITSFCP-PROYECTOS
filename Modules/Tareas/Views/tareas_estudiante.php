...
<div class="container-fluid py-4 ancho_container">
    ...
    <div class="row mb-4 align-items-center">
        ...
        <div class="col-6 col-md-6 text-md-end">
            <a href="/Modules/Proyectos/Views/index.php" class="btn btn-outline-secondary btn-sm">
                        ...
                        <div class="act-item">
                            ...
                            <div class="act-body" id="<?= $bodyId ?>">
                                ...
                                <?php if (!empty($tarea['archivo_nombre'])): ?>
                                    <a href="/Modules/Tareas/Views/descargar_guia.php?id_tarea=<?= (int)$tarea['id_tarea'] ?>"
                                ...
                                <div class="act-footer">
                                    ...
                                    <a href="/Modules/Tareas/Views/tarea.php?id_asignacion=<?= (int)$tarea['id_asignacion'] ?>&id_tarea=<?= (int)$tarea['id_tarea'] ?>&id_proyectos=<?= (int)$tarea['id_proyectos'] ?>"
