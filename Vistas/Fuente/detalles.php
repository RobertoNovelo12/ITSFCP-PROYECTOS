...
$registro = $fuenteControlador->indexDetalles($rol, $id_fuente);

if (empty($registro)) {
    die("No se encontró el Fuente.");
}
...
<div class="container-fluid py-4">
    ...
    <div class="row mb-4 align-items-center">
        <div class="col-md-6">
            <h3 class="fw-bold mb-0">Detalles de Fuente</h3>
        </div>
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-light">
            <h5 class="mb-0">Información de Fuente</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <div class="col-md-12">
                    <dl>
                        <dt>Fuente</dt>
                        <dd>
                            <?= htmlspecialchars($registro['fuente']) ?>
                        </dd>
                    </dl>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <dl>
                        <dt>Estado</dt>
                        <dd>
                            <span class="badge rounded-pill text-bg-<?= $fuenteControlador->EstiloEstadoLista($registro['estado']); ?>">
