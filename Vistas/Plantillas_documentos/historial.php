...
if ($id_plantilla == null) {
    die("ERROR: No se recibió id_plantilla");
}
...
// DATOS
$historialAgrupado = $plantilladocumentoControlador->info_linea_tiempo($id_plantilla);
    ...
    <div class="row mb-3 align-items-center">
        ...
        <div class="row mb-1">
            ...
            <div class="col-6 text-end">
                <a href="tabla.php?id_plantilla=<?= $id_plantilla; ?>" class="btn btn-danger">Regresar</a>
            </div>
        </div>
                            ...
                            <li>
                                ...
                                <div class="timeline-content">
                                    ...
                                    <div class="timeline-header">
                                        ...
                                        <span class="titulo <?= ($item['estado'] == 'Activo') ? 'activo' : 'desactivado' ?>">

                                            <span class="badge bg-<?= ($item['tipo_evento'] == 'Creación') ? 'success' : 'warning' ?>">
                                                <?= $item['tipo_evento'] ?>
                                            </span> - <?= $item['nombre'] ?>
