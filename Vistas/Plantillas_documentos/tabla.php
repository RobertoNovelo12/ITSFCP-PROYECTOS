...
if ($_SERVER['REQUEST_METHOD'] == 'GET' && $action == 'desactivar') {
    ...
    $plantilladocumento->desactivar($rol, $id_plantilla);
                    ...
                    <?php if (!empty($registros)) { ?>
                        <?php foreach ($registros as $reg): ?>
                            <tr>
                                ...
                                <td>
                                    <span class="badge rounded-pill text-bg-<?php echo $plantilladocumento->EstiloEstado($reg['estado']); ?>">
                                        <?= htmlspecialchars($reg['estado']) ?>
                                    </span>
                                </td>
                                <td>
                                    <?= $plantilladocumento->botonesAccionPrincipal($reg['id_plantilla'], $rol, $reg['estados']) ?>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php } else { ?>
            ...
            <div class="card shadow-sm mb-3">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-center gap-2">
                        <?php echo $plantilladocumento->botonesAccionPrincipal($reg['id_plantilla'], $rol, $reg['estados']); ?>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
