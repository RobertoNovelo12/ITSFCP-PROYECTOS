...
/* CONTROLADOR */
require_once '../../Controladores/sniControlador.php';

$action = $_POST['action'] ?? null;
$sniControlador = new sniControlador();
$estadoVista = $sniControlador->obtenerEstadoVista();
$datos = $estadoVista['datos'];


if ($action === 'registrarSNI') {
    $periodoControlador->registrarSNI($rol);
}

if ($action === 'reactivarSNI') {
