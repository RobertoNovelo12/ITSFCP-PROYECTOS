...
<div class="container-fluid py-4">
        ...
        <div class="col-md-6">
            <div class="card shadow-sm">
                ...
                <div class="card-body" style="max-height:280px;overflow-y:auto;">
                    ...
                    <div class="inv-card d-flex justify-content-between align-items-center">
                        <div>
                            <div class="fw-semibold small"><?= htmlspecialchars($inv['nombre']) ?></div>
                            <div class="text-muted" style="font-size:.75rem"><?= htmlspecialchars($inv['correo_institucional']) ?></div>
                        </div>
                        <div class="text-end">
                            <span class="badge bg-primary"><?= $inv['total_proyectos'] ?> proy.</span>
                            <br><span class="small text-success"><?= $inv['activos'] ?> activos</span>
                        </div>
                    </div>
                    <?php endforeach; ?>
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item">
                                    <div class="row text-center">
                                        <div class="col-4"><strong>Total</strong><p class="mb-0"><?= $sec['total_instancias'] ?></p></div>
                                        <div class="col-4"><strong class="text-success">Aprob.</strong><p class="mb-0 fw-bold text-success"><?= $sec['aprobadas'] ?></p></div>
                                        <div class="col-4"><strong class="text-danger">Venc.</strong><p class="mb-0 text-danger"><?= $sec['vencidas'] ?></p></div>
                                    </div>
                                </li>
                                <li class="list-group-item">
                                    <div class="row text-center">
                                        <div class="col-4"><strong class="text-info">Revisión</strong><p class="mb-0"><?= $sec['en_revision'] ?></p></div>
                                        <div class="col-4"><strong class="text-warning">Correc.</strong><p class="mb-0"><?= $sec['correcciones'] ?></p></div>
                                        <div class="col-4"><strong class="text-secondary">Pend.</strong><p class="mb-0"><?= $sec['pendientes'] ?></p></div>
                                    </div>
                                </li>
                            </ul>
                        </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            <th>Proyecto</th><th>Investigador</th><th class="text-center">Estado</th>
                            <th class="text-center">Modalidad</th><th class="text-center">Alumnos</th>
                            <th class="text-center">Sol. pend.</th><th class="text-center">Tareas venc.</th>
                            <th class="text-center">Fechas</th><th></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr><td colspan="9" class="text-center text-muted py-4">No se encontraron proyectos.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            <th>Estudiante</th><th>Matrícula</th><th>Carrera</th><th>Proyecto</th>
                            <th>Investigador</th><th class="text-center">Estado</th>
                            <th class="text-center">Semestre</th><th class="text-center">Promedio</th>
                    ...
                    <tbody>
                        ...
                        <tr><td colspan="9" class="text-center text-muted py-4">No se encontraron solicitudes.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
    ...
    <div class="row g-3 mb-4">
            ...
            <div class="card shadow-sm h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="row text-center g-1">
                        <div class="col-3"><div class="small text-muted">Total</div><div class="fw-bold"><?= $etapa['total'] ?></div></div>
                        <div class="col-3"><div class="small text-secondary">Pend.</div><div class="fw-bold text-secondary"><?= $etapa['pendientes'] ?></div></div>
                        <div class="col-3"><div class="small text-primary">Proceso</div><div class="fw-bold text-primary"><?= $etapa['en_proceso'] ?></div></div>
                        <div class="col-3"><div class="small text-success">Compl.</div><div class="fw-bold text-success"><?= $etapa['completados'] ?></div></div>
                    </div>
        ...
        <div class="col-12"><p class="text-muted text-center">Sin etapas configuradas.</p></div>
        <?php endif; ?>
    </div>
            ...
            <div class="table-responsive d-none d-md-block">
                <table class="table table-sm align-middle mb-0">
                    ...
                    <tbody>
                        ...
                        <?php endforeach; ?>
                        <?php if (empty($etapas_data['secciones'])): ?>
                        <tr><td colspan="9" class="text-center text-muted py-3">Sin datos de tareas.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
        ...
        <div class="card-body p-0">
            <div class="table-responsive">
                <table class="table table-hover align-middle mb-0">
                    <thead class="table-light">
                        <tr>
                            <th>Estudiante</th><th>Matrícula</th><th>Carrera</th>
                            <th class="text-center">Estado</th><th class="text-center">Proyectos</th>
                            <th style="min-width:140px">Avance tareas</th>
                            <th class="text-center">Registro</th><th></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr><td colspan="8" class="text-center text-muted py-4">No se encontraron estudiantes.</td></tr>
                        <?php endif; ?>
                    </tbody>
                </table>
            </div>
