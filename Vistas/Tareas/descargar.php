 ...
 * descargar.php
 *
 * Descarga segura del documento entregas adjunto a una tarea
 * por el investigador (campo id_documento_entrega en tareas_usuarios).
 *
 * Requiere:
 *  - Sesión activa
 *  - GET['id_tarea'] → int
 ...
 *  - Validación de que la tarea tenga entrega adjunto
 *  - El documento debe ser tipo 'entrega' y estar activo
...
//  Consultar tarea en BD 
// Obtiene el documento recurso activo vinculado a la tarea.
// el documento sea de tipo 'entrega' y esté activo.

$S    = new Tarea($conn);
$file = $S->obtenerTareaPorId($id_asignacion);
...
//   a) Absoluta web:   /ITSFCP-PROYECTOS/storage/entregas/tarea_5/archivo.pdf
//   b) Relativa pura:  storage/entregas/tarea_5/archivo.pdf
