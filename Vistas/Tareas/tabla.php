                        ...
                        <tbody class="text-center">
                            <?php if ($rol == "estudiante") {
                                foreach ($tarea as $tar) {
                                    ...
                                    echo "<td><a href='descargar_guia.php?id=" . $tar['id_avances'] . "'>Descargar</a></td>";
                                ...
                                foreach ($tarea as $tar) {
                                    ...
                                    echo "<td><a href='descargar_guia.php?id=" . $tar['id_avances'] . "'><svg xmlns='http://www.w3.org/2000/svg' width='18' height='18' fill='red' class='bi bi-file-earmark-pdf-fill' viewBox='0 0 16 16'>
