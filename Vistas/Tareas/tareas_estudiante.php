...
<style>
.task-card { border: 1px solid #e9ecef; border-radius: .5rem; transition: box-shadow .15s; }
.task-card:hover { box-shadow: 0 2px 8px rgba(0,0,0,.1); }
.task-badge-estado { font-size: .75rem; }
.task-tipo { font-size: .8rem; color: #6c757d; font-weight: 600; text-transform: uppercase; letter-spacing: .04em; }
.task-instrucciones { display: -webkit-box; -webkit-line-clamp: 3; -webkit-box-orient: vertical; overflow: hidden; font-size: .9rem; color: #495057; }
.task-editada-badge { font-size: .7rem; color: #856404; background: #fff3cd; border-radius: .25rem; padding: .1rem .4rem; display: inline-flex; align-items: center; gap: .25rem; }
</style>
...
<div class="container-fluid py-4" style="max-width:720px;">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4 gap-2">
        ...
        <a href="../../Vistas/Proyectos/tabla.php" class="btn btn-outline-danger btn-sm px-3">← Regresar</a>
    </div>
