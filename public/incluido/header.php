        ...
        <?php else: ?>
            ...
            <div class="notif-wrapper">
                <div class="notif-icon" id="notifBtn">
                    <img src="/public/icons/notificacion.svg" alt="Notificaciones">
                    <?php if ($no_leidas > 0): ?>
            ...
            <div class="profile-wrapper" id="userProfileBtn">
                ...
                <?php endif; ?>
                <img class="avatar-arrow" src="/public/icons/caretaa.svg" alt="Menú">
            </div>
...
notifBtn.addEventListener('click', () => {
    ...
    fetch('/Modules/Notificaciones/Views/lista.php')
        .then(res => res.json())
        .then(data => {
            if (data.status === 'ok') {
