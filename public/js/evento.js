document.addEventListener("DOMContentLoaded", function () {
  ...
  function cargarProyectos() {
    fetch("/ITSFCP-PROYECTOS/Modules/Calendario/Views/obtener_proyectos.php")
      .then((res) => res.json())
      .then((lista) => {
        console.log(lista);
  ...
  proyectoModal.addEventListener("change", function () {
    ...
    fetch(
      `/ITSFCP-PROYECTOS/Modules/Eventos/Views/crear.php?getEstudiantes=1&id_proyecto=${id}`
    )
      .then((res) => res.json())
      .then((estudiantes) => {
  ...
  formModal.addEventListener("submit", function (e) {
    ...
    fetch("/ITSFCP-PROYECTOS/Modules/Eventos/Views/crear.php", {
      method: "POST",
      body: formData,
    })
      .then((res) => res.json())
