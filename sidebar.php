...
function crearLink($nombre, $rol)
{
    $links = [
        ...
        "Actualizar datos" => "/ITSFCP-PROYECTOS/Vistas/Solicitudes_actualizacion/index.php",
        ...
        "Mis solicitudes" => "/ITSFCP-PROYECTOS/Vistas/Mis_solicitudes/index.php",
        ...
        "Línea de investigación" => "/ITSFCP-PROYECTOS/Vistas/Linea_investigacion/index.php",
        "Temática" => "/ITSFCP-PROYECTOS/Vistas/Tematica/index.php",
        "Área de conocimiento" => "/ITSFCP-PROYECTOS/Vistas/Areas_conocimiento/index.php",
        ...
        "Grados académicos" => "/ITSFCP-PROYECTOS/Vistas/Grados_academicos/index.php",
